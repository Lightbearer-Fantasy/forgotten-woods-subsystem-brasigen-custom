...
export const GROUP_ACTIVITIES = [
    ...
    },
    {
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Monter le camp</strong> — Vous ne pouvez faire cela que dans un Hex ayant au moins 2 PC. Tant que vous restez sur ce Hex, votre groupe peut effectuer deux Activités Individuelles supplémentaires."
    },
    {
        id: "hustle",
    ...
    },
    {
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Se reposer</strong> — Nécessite un camp. Lorsque vous vous Reposez, vous ne pouvez pas vous déplacer de la journée. Récupérez le triple du montant normal de points de vie récupéré lors d'un repos long. Si vous êtes Fatigued, lors des prochaines préparations quotidiennes, vous perdez la condition et vous récupérez deux Activités de Groupe."
    },
    {
        id: "travel",
        label: "Voyager",
...
export const INDIVIDUAL_ACTIVITIES = [
    {
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Avoid Notice</strong> — Vous et les membres de votre groupe qui le souhaitent peuvent effectuer leur jet d'initiative avec leur Stealth."
    },
    {
        id: "hunt-and-gather",
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Chasser et cueillir</strong> — Vous essayez de trouver des ingrédients frais sur le trajet. Effectuez un jet de Nature ou de Survie contre le DC de la zone." +
            "<ul>" +
            "<li><strong>Réussite Critique :</strong> Vous trouvez 3 ingrédients frais.</li>" +
            "<li><strong>Réussite :</strong> Vous trouvez 2 ingrédients frais.</li>" +
            "<li><strong>Echec :</strong> Vous revenez bredouille.</li>" +
            "</ul>"
    },
    {
        id: "repair",
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Craft - Repair</strong> — Fonctionne comme les activités Craft ou Repair, et vous pouvez Craft ou Repair un item ou un batch de 4 items par Activité. Une Réussite réduit le coût de Craft de 10% et une Réussie Critique de 20%."
    },
    {
        id: "cook",
        label: "Cuisiner",
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Cuisiner</strong> — Nécessite un camp. Vous cuisinez des ingrédients frais pour vous remplir la panse et galvaniser le moral de vos compagnons." +
            "<ul>" +
            "<li><strong>Réussite Critique :</strong> Comme la Réussite, et vous gagnez un bonus sans type de +1 au prochain jet d'attaque, de sauvegarde ou de compétence que vous effectuez le lendemain.</li>" +
            "<li><strong>Réussite :</strong> Vous gagnez une Activité de Groupe supplémentaire le lendemain.</li>" +
            "<li><strong>Echec :</strong> Vous ne parvenez pas à cuisiner un plat satisfaisant mais vous parvenez à économiser les ingrédients frais.</li>" +
            "</ul>"
    },
    {
        id: "defend",
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Defend</strong> — Vous commencez toute Rencontre avec le bouclier levé et votre réaction. La nuit au camp, si une embuscade nocturne survient, vous montez la garde, vous empêchant vous et vos compagnons d'être surpris."
    },
    {
        id: "aid",
        label: "S'entraider",
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>S'entraider</strong> — Choisissez deux alliés qui n'utilisent ou ne bénéficient pas de cette activité. La première fois dans la journée que chacun de ces alliés effectue un jet de compétence, vous pouvez Aid comme si vous aviez préparé la réaction correspondante."
    },
    {
        id: "investigate",
        label: "Investigate",
    ...
    },
    {
        ...
        img: PLACEHOLDER_IMG,
        chatText:
            "<strong>Scout</strong> — Vous patrouillez en tout temps dans les environs pour avoir un coup d'avance. Vous déterminez si des créatures hostiles, cachées ou non, sont présentes sur une Hex adjacente. Vous et vos compagnons gagnez un bonus de circonstance de +1 à tous vos jets d'initiative."
    },
    {
        id: "search",
        label: "Search",
